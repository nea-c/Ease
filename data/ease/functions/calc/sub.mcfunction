...
data modify storage ease: _.sign set string storage ease: _.transformation.scale[2] 0 1
execute unless data storage ease: _{sign:"-"} store result storage ease: _.abs_bigger int 1 run data get storage ease: calcIn.x 1
execute if data storage ease: _{sign:"-"} store result storage ease: _.abs_bigger int -1 run data get storage ease: calcIn.y 1
data modify storage ease: _.sign set string storage ease: _.abs_bigger 0 1

# 正の場合
execute unless data storage ease: _{sign:"-"} run data modify storage ease: out set from storage ease: _.transformation.scale[1]
...
execute if data storage ease: _{sign:"-"} run data modify storage ease: _.matrix[3] set from storage ease: _.transformation.scale[1]
