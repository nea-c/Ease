...
execute unless data storage ease: _{minus:"-"} store result storage ease: _.abs int 1 run data get storage ease: calcIn.x 1
execute if data storage ease: _{minus:"-"} store result storage ease: _.abs int -1 run data get storage ease: calcIn.y 1
data modify storage ease: _.minus set string storage ease: _.abs 0 1
